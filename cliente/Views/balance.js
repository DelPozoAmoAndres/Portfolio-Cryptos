...
import { getActives, addHistory, getPorcetage, getTotal,getPorcentageActive } from '../services/balanceService';
        ...
        <View style={{ borderColor: "gray", borderWidth: 1, paddingLeft: "2%", paddingRight: "2%" }}>
            <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", alignContent: "flex-end" }}>
                <View style={{ flexDirection: "row" }}>
                    <Image style={{ height8: 40, width: 40 }} source={{ uri: "https://bscscan.com" + item.value[4] }} />
                    <Text> </Text>
